...
?>
<form name="opmd" action="action/crudpro.php" method="post">
...
<div class="content-wrapper">
	<h4 class="title">Seccion de provedores</h4>
...
{
		$idp = $query_result['IdProveedor'];
    $nombrepro = $query_result['Nombre'];
    $direccion=$query_result['Direccion'];
