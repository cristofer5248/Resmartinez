			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 to-animate-2">
						...
						<div class="form-group ">
							<label for="date" class="sr-only">Fecha de nacimiento</label>
							<input id="date" class="form-control" placeholder="Fecha de nacimiento" type="text">
						</div>
						...
						<div class="form-group ">
							...
							<input name="" id="password"  class="form-control" type="password" placeholder="Contraseña"></input>
						</div>
						<div class="form-group ">
